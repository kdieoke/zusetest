    ...
    <ion-page>
        ...
        <ion-content>
            ...
            <ion-card>
                ...
                <ion-card-content>Bitte melde dich mit deinen Anmeldedaten an</ion-card-content>
            </ion-card>

            <!-- New Card -->
            <ion-card>
                <ion-item>
                    <ion-input v-model="username" class="pw" label="Benutzername"></ion-input>
                </ion-item>
                <ion-item>
                    <ion-input v-model="password" class="pw" label="Passwort" type="password"></ion-input>
                </ion-item>
            </ion-card>
